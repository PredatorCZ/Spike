...
#ifndef BUILDVERSION
#pragma message("Please add BUILDVERSION=$(Configuration) into preprocessor definitions.")
#endif
...
#define VERSION_3DSMAX_E(Version) ((MAX_RELEASE_EVAL(Version)<<16)+(MAX_API_EVAL(Version)<<8))
