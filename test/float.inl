...
int test_float_00() {
  ...
  const Vector4A16 rst =
      float16::ToVector4(IVector4A16(num0, num1, num2, num4));
...
int test_float_01() {
  ...
  TEST_EQUAL(float16::FromFloat(num1), 0x1f);
  TEST_EQUAL(float16::FromFloat(num2), 0x7c00);
  TEST_EQUAL(float16::FromFloat(num3), 0x7fff);
  TEST_EQUAL(float16::FromFloat(num4), 0xe2a7);

  const IVector4A16 rst =
      float16::FromVector4(Vector4A16(num0, num1, num2, num4));
